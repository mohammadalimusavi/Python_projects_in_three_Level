...
# store the last calculation -----> History.
...
tk.Button(window, text="0", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#2a2d36", command=lambda: show("0")).place(x=10, y=500)
tk.Button(window, text="history", width=5, height=1, font=("arial", 30), bd=1, fg="#fff", bg="#2a2d36", command=show_history).place(x=150, y=500)
